...
class ManagementCommandTest(TestCase):
    ...
    def test_benchmark_baseline_success(self, mock_post: MagicMock) -> None:
    ...
    @patch("fuel_stations.management.commands.benchmark_baseline.requests.post")
    def test_benchmark_baseline_api_error(self, mock_post: MagicMock) -> None:
    ...
    def test_benchmark_cached_success(
        self, mock_post: MagicMock, mock_cache: MagicMock
    ) -> None:
    ...
    @patch("fuel_stations.management.commands.benchmark_cached.cache")
    @patch("fuel_stations.management.commands.benchmark_cached.requests.post")
    def test_benchmark_cached_api_error(
        self, mock_post: MagicMock, mock_cache: MagicMock
    ) -> None:
    ...
    @patch("fuel_stations.management.commands.benchmark_baseline.requests.post")
    def test_benchmark_baseline_mixed_response(self, mock_post: MagicMock) -> None:
