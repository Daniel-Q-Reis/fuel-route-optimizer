...
class TimestampedModel(models.Model):
    ...
    created_at: models.DateTimeField = models.DateTimeField(  # type: ignore[type-arg]
        auto_now_add=True, help_text="Timestamp when the record was created"
    )
    updated_at: models.DateTimeField = models.DateTimeField(  # type: ignore[type-arg]
...
class ActivatableModel(TimestampedModel):
    ...
    is_active: models.BooleanField = models.BooleanField(  # type: ignore[type-arg]
        default=True, help_text="Whether this record is active"
    )

    objects: BaseManager[Any] = BaseManager()  # type: ignore[misc]
...
class AuthorableModel(TimestampedModel):
    ...
    created_by: models.ForeignKey = models.ForeignKey(  # type: ignore[type-arg]
        "auth.User",
    ...
    updated_by: models.ForeignKey = models.ForeignKey(  # type: ignore[type-arg]
        "auth.User",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
...
class SluggedModel(models.Model):
    ...
    slug: models.SlugField = models.SlugField(  # type: ignore[type-arg]
...
class Post(ActivatableModel, SluggedModel):
    ...
    objects: BaseManager["Post"] = BaseManager()  # type: ignore[misc]

    title: models.CharField = models.CharField(  # type: ignore[type-arg]
        max_length=255, help_text="The title of the post."
    )
    content: models.TextField = models.TextField(  # type: ignore[type-arg]
        help_text="The main content of the post."
    )
    author: models.ForeignKey = models.ForeignKey(  # type: ignore[type-arg]
        "auth.User",
    ...
    class Meta(ActivatableModel.Meta, SluggedModel.Meta):
        verbose_name = "Post"
