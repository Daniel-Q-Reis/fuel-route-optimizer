...
def run_benchmark() -> None:
    ...
    print("  • Network latency (BR→DE): ~200-250ms  (20-25%)")
    print("  • ORS API processing:      ~700-750ms  (70-75%)")
    print("  • Django processing:       ~30-50ms    (3-5%)")
    print("  • Database queries:        ~5-10ms     (~1%)")

    print("\n✅ Baseline benchmark complete!")
    print("Results saved to: docs/performance/baseline_benchmark.md\n")
